...
namespace Nop.Plugin.Payments.BerkutPay.Components
{
    public class BerkutPayViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.BerkutPay/Views/PaymentInfo.cshtml", model);
        }
    }
}
